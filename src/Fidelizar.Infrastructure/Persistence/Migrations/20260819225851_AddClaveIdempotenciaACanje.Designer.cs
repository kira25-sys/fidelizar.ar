...
namespace Fidelizar.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260819225851_AddClaveIdempotenciaACanje")]
    partial class AddClaveIdempotenciaACanje
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fidelizar.Domain.Entities.Corte", b =>
                {
                    ...
                    b.HasIndex("DeclaradoPorUsuarioId");
            ...
            modelBuilder.Entity("Fidelizar.Domain.Entities.MovimientoCredito", b =>
                {
                    ...
                    b.HasIndex("NegocioId", "ClaveIdempotencia")
                        .IsUnique()
            ...
            modelBuilder.Entity("Fidelizar.Domain.Entities.ConfiguracionPrograma", b =>
                {
                    b.HasOne("Fidelizar.Domain.Entities.Usuario", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Fidelizar.Domain.Entities.Corte", b =>
                {
                    b.HasOne("Fidelizar.Domain.Entities.Usuario", null)
                        .WithMany()
                        .HasForeignKey("DeclaradoPorUsuarioId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
